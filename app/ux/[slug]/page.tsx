...
export async function generateStaticParams() {
  return projects
    .filter((p) => p.categories.includes("Desarrollo web y diseño web"))
    .map((p) => ({
      slug: p.slug,
    }))
}
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 selection:bg-blue-500/30">
      ...
      <nav className="fixed top-0 w-full bg-gray-950/80 backdrop-blur-md border-b border-gray-800/50 z-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <Link href="/#projects" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2 text-sm font-medium">
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-8">
              ...
              <div className="flex flex-wrap gap-4 mb-12">
                {project.live && (
                  <Button size="lg" className="bg-white text-gray-950 hover:bg-gray-200 font-medium px-8 rounded-full">
                ...
                {project.github && (
                   <Button variant="outline" size="lg" className="border-gray-700 text-gray-300 hover:bg-gray-800 bg-transparent rounded-full px-8">
            ...
            <div className="lg:col-span-4 bg-gray-900/50 border border-gray-800/50 rounded-2xl p-8 backdrop-blur-sm">
               <div className="space-y-6">
                 {caseStudy?.heroIntro?.services && (
                    <div>
                      <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Servicios</h4>
                      <p className="text-gray-200 font-medium">{caseStudy.heroIntro.services.join(", ")}</p>
                    </div>
                 )}
                 {caseStudy?.heroIntro?.industry && (
                    <div>
                      <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Industria</h4>
                      <p className="text-gray-200 font-medium">{caseStudy.heroIntro.industry}</p>
                    </div>
                 )}
                 {(caseStudy?.heroIntro?.tools || project.tech) && (
                    <div>
                      <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Herramientas</h4>
      ...
      {caseStudy?.contextAndChallenge && (
        <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-900/20">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 tracking-tight">El Contexto y el Reto</h2>
            <div className="text-xl text-gray-400 leading-relaxed font-light text-left md:text-center space-y-6">
               {caseStudy.contextAndChallenge.description.split('👉 Problema real:').map((part, idx) => {
                  if (idx === 1) {
                     return (
                        <div key={idx} className="mt-12 bg-gradient-to-br from-blue-900/30 to-purple-900/20 border border-blue-500/30 p-8 md:p-10 rounded-3xl shadow-2xl relative overflow-hidden">
                          ...
                          <h3 className="text-blue-400 font-bold text-xs md:text-sm uppercase tracking-widest mb-4 relative z-10">El Problema Real</h3>
            ...
            <div className="grid lg:grid-cols-2 gap-16">
               ...
               {caseStudy.userInsights && (
                 <div>
                   ...
                   <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 tracking-tight">Entendiendo al Usuario</h2>
               ...
               {caseStudy.uxResearch && (
                 <div>
                   ...
                   <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 tracking-tight">Validación & Benchmark</h2>
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
             <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                   <Badge className="mb-6 bg-purple-500/10 text-purple-400 border-purple-500/20">Identidad Visual</Badge>
                   <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 tracking-tight">Branding y Estética</h2>
                   <p className="text-lg text-gray-400 leading-relaxed mb-8">
                     {caseStudy.branding.designJustification || "La estética se centró en transmitir confianza y modernidad a través de tipografías legibles y una paleta de colores coherente con la industria."}
                   </p>
                   
                   {/* Colors */}
                   {caseStudy.branding.colors && (
                     <div className="mb-8 items-center flex flex-wrap gap-4">
                       <h4 className="text-sm font-medium text-gray-300 w-full">Paleta de Colores</h4>
                   ...
                   {caseStudy.branding.typography && (
                     <div>
                       <h4 className="text-sm font-medium text-gray-300 mb-4">Tipografía</h4>
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-900/20">
          <div className="max-w-6xl mx-auto">
             <div className="text-center max-w-3xl mx-auto mb-16">
               <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 tracking-tight">Arquitectura y User Flows</h2>
        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
             <div className="mb-16">
               ...
               <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 tracking-tight">Decisiones Clave de UX</h2>
             </div>
             ...
             {caseStudy.accessibility && (
               <div className="bg-gradient-to-br from-indigo-900/40 to-gray-900 border border-gray-800 p-10 md:p-12 rounded-[2.5rem]">
                 <div className="max-w-3xl">
                   <h3 className="text-2xl font-bold text-white mb-4">Accesibilidad y Usabilidad</h3>
            ...
            <div className="max-w-6xl mx-auto">
               <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-16">
                  <div className="max-w-2xl">
                    <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 tracking-tight">Diseño de Interfaz (UI)</h2>
            ...
            <div className="max-w-6xl mx-auto">
               <div className="grid lg:grid-cols-2 gap-16 items-center">
                  <div className="order-2 lg:order-1">
                     <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 tracking-tight">Experiencia Mobile</h2>
            ...
            <div className="max-w-6xl mx-auto relative z-10">
               {caseStudy.results.description && (
                 <div className="text-center max-w-2xl mx-auto mb-16">
                    <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 tracking-tight">El Impacto</h2>
                    <p className="text-lg text-gray-400">
                       {caseStudy.results.description}
                    </p>
                 </div>
               ...
               {caseStudy.results.metrics && caseStudy.results.metrics.length > 0 && (
                 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {caseStudy.results.metrics.map((metric, idx) => (
                       <div key={idx} className="bg-gray-900/80 backdrop-blur p-10 rounded-3xl border border-gray-800/50 text-center shadow-xl hover:-translate-y-1 transition-transform">
                          <div className="text-5xl sm:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 mb-4 tracking-tighter drop-shadow-sm">
                             {metric.value}
                          </div>
                          <p className="text-xl text-gray-300 font-medium">{metric.label}</p>
                       </div>
                    ))}
                 </div>
               )}
             ...
             {(caseStudy.results.learnings || caseStudy.results.nextSteps) && (
                <div className="mt-24 grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                   {caseStudy.results.learnings && (
                      <div className="bg-gray-900/80 p-10 rounded-3xl border border-gray-800/50 shadow-lg">
                         <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                            <span className="text-2xl">🧠</span> Aprendizajes
                         </h3>
                   ...
                   {caseStudy.results.nextSteps && (
                      <div className="bg-gray-900/80 p-10 rounded-3xl border border-gray-800/50 shadow-lg">
                         <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                            <span className="text-2xl">🚀</span> Próximos Pasos
                         </h3>
                         <ul className="space-y-5">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-gray-900 bg-gray-950">
         <div className="max-w-6xl mx-auto">
            {relatedProjects.length > 0 && (
               <div className="mb-32">
                  <h3 className="text-3xl font-bold text-white mb-10 text-center tracking-tight">Proyectos Relacionados</h3>
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
                     {relatedProjects.map(rel => (
                        <Link key={rel.slug} href={rel.caseStudy ? `/ux/${rel.slug}` : rel.live || rel.github || '#'} className="group block">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-[3rem] p-12 sm:p-20 text-center shadow-2xl relative overflow-hidden">
               ...
               <div className="relative z-10 max-w-3xl mx-auto">
                  <h2 className="text-4xl sm:text-6xl font-bold text-white mb-8 tracking-tight">¿Listo para mejorar tu producto?</h2>
                  ...
                  <Button size="lg" className="bg-white text-blue-900 hover:bg-gray-100 text-lg sm:text-xl px-10 py-8 rounded-full font-bold shadow-xl hover:scale-105 transition-transform">
      ...
      <footer className="py-12 border-t border-gray-900 text-center text-gray-500 text-sm">
         <p>© {new Date().getFullYear()} Pablo Ezeta. All rights reserved.</p>
      </footer>
    </div>
  )
}
